...
CREATE TABLE dim_Stock (
    ...
    State NVARCHAR(50),                             -- State from Stock_Move and Stock_Move_Line
    ...
    Date_StockMove DATETIME,                            -- Create Date from Stock_Move, Stock_Move_Line, and Stock_Quant
    Date_Moveline DATETIME,                             -- Write Date from Stock_Move, Stock_Move_Line, and Stock_Quant
